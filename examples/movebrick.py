...
config_key = dict()
config_key['binance'] = ['UFBp3ZnEWN6ZBTV3mRAJYG9sxEQKVEemyWGmLfj8Jc2eu4GNnfdz1mwnSVfdXvrd','dx3dcb13tDyw68oGEVet5NLAZp5UpMpd2Nuywgf9gKb02692Ko5YQFO9Ae4s8jx6']
config_key['huobipro'] = ['uex_key','uex_secret']
config_key['okex'] = ['uex_key','uex_secret']
...
async def find_trade_object(symbol,exchange_list):
    ...
    if bid_exchange and ask_exchange:
        ...
        global totalprofit
        totalprofit =totalprofit +profits
